...
public class LoginPage extends SanveoBase{
	...
	public LoginPage() {
		...
		public HomePage LoginPage(String stage) throws IOException, ParseException {

			driver.findElement(By.id("nav-link-accountList")).click();
			driver.findElement(By.id("ap_email")).sendKeys(TestUtil.readJsonConfiguration(stage, "username"));
			...
			driver.findElement(By.id("ap_password")).sendKeys(TestUtil.readJsonConfiguration(stage, "password"));
